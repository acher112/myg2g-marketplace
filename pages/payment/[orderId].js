...
export default function PaymentPage() {
  ...
  // Auto redirect when submitted - MOVED TO TOP LEVEL
  useEffect(() => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4">
        <div className="bg-slate-800 rounded-2xl p-8 max-w-md w-full text-center border border-green-500/30">
          ...
          <Link 
            href={`/order/${orderId}`}
            className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg inline-block transition"
          >
        ...
        <div className="container mx-auto max-w-2xl">
          <div className="bg-slate-800 rounded-2xl p-8 border border-purple-500/30">
            ...
            <p className="text-center text-sm text-gray-400 mt-4">
              After clicking, you'll be redirected to track your order status
            </p>
          </div>
        </div>
      </div>
